...
r"""----------------------------------------------------------------------------
@File    : MobileNetV3.py
@Time    : 2024/7/21 20:46
@Author  : Zheng Han 
@Contact : tourensong@gmail.com
@License : (C)Copyright 2024, ZhengHan. All rights reserved.
@Desc    : PyCodes of MobileNetV3
https://arxiv.org/abs/1905.02244
https://blog.csdn.net/baidu_36913330/article/details/120083490
-----------------------------------------------------------------------------"""
...
def mobilenet_v3_large(num_classes: int = 1000, in_channels=3, ) -> MobileNetV3:
    r"""
    ...
    return MobileNetV3(inverted_residual_setting, last_channel, num_classes=num_classes, in_channels=in_channels)


def mobilenet_v3_small(num_classes: int = 1000, in_channels=3, ) -> MobileNetV3:
    r"""
