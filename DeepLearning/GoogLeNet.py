...
r"""----------------------------------------------------------------------------
@File    : GoogleNet.py
@Time    : 2024/7/21 20:04
@Author  : Zheng Han 
@Contact : tourensong@gmail.com
@License : (C)Copyright 2024, ZhengHan. All rights reserved.
@Desc    : PyCodes of GoogleNet
https://arxiv.org/abs/1409.4842
https://blog.csdn.net/Vermont_/article/details/108836111
-----------------------------------------------------------------------------"""
import warnings
...
from DeepLearning.Backbone import BasicConv2d, Inception
...
class GoogLeNet(nn.Module):
    ...
    def forward(self, x: Tensor):
        ...
        if torch.jit.is_scripting():
            ...
            if self.is_training:
                return GoogLeNetOutputs(x, aux2, aux1).logits
            else:
...
def main():
    inception = Inception(192, 160, 112, 224, 24, 64, 64)
    x = torch.rand(10, 192, 7, 7)
    out_x = inception(x)
    print(out_x.shape)
    return
