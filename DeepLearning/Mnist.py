...
r"""----------------------------------------------------------------------------
@File    : Mnist.py
@Time    : 2023/12/1 21:46
@Author  : Zheng Han 
@Contact : hzsongrentou1580@gmail.com
@License : (C)Copyright 2023, ZhengHan. All rights reserved.
@Desc    : PyCodes of Mnist
-----------------------------------------------------------------------------"""
...
BATCH_SIZE = 256
EPOCHS = 10
trainData = torchvision.datasets.MNIST(r"F:\ProjectSet\Shadow\Temp\mnist", train=True, transform=transform, download=True)
testData = torchvision.datasets.MNIST(r"F:\ProjectSet\Shadow\Temp\mnist", train=False, transform=transform)
