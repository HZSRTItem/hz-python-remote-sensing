...
class StatusTorchModel:
    ...
    def model(self, model, input_size, batch_size=-1, device="cuda"):
        ...
        def register_hook(module):
            ...
            def hook(_module, _input, output):
                ...
                summary[m_key]["input_shape"] = list(_input[0].size())
                ...
                if hasattr(_module, "weight") and hasattr(_module.weight, "size"):
                    ...
                    summary[m_key]["trainable"] = _module.weight.requires_grad
        ...
        device = device.lower()
        # assert device in ["cuda", "cuda:0", "cpu", ], "Input device is not valid, please specify 'cuda:x' or 'cpu'"
