...
class ZY2MAdmj_Main:
    ...
    def __init__(self):
        ...
        self.csv_fn = JPZ5M_XIANLI21_DFN.fn(r"Samples\{0}\jpz2m_spl_train8_1.csv".format(YEAR))
        self.npy_fn = JPZ5M_XIANLI21_DFN.fn(r"Samples\{0}\jpz2m_spl_train8_1_sum.npy".format(YEAR))
        self.test_ds = None
        self.train_ds = None
        self.win_size = 5
        self.mod = ZY2MAdmj_Network_res(in_channel=4, win_size=self.win_size, n_category=1)
        self.loss = ZY2MAdmj_Loss()
        self.geo_raster = JPZ5M_XIANLI21_DFN.fn(r"Images\jpz2m_{0}_2.tif".format(YEAR))
...
if __name__ == "__main__":
    """
    F:\PyCodes\ZY5M\ZY2MAdmjC.py
    run import sys; sys.path.append(r'F:\PyCodes'); from Y5M.ShadowData import ZY2MAdmjC; zy2m_admj = ZY2MAdmj_Main();zy2m_admj.imdcOne()
    python -c "import sys; sys.path.append(r'F:\PyCodes'); from ZY5M.ZY2MAdmjC import imdcOne; imdcOne(r'H:\JPZ\ZY2MAdmj\Mods\20231119H204151\mmodel_44.pth')"
    """
    main()
    # imdcOne(r"H:\JPZ\ZY2MAdmj\Mods\20231120H134828\model_epoch_22.pth")
