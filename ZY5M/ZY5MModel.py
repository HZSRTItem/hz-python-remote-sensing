...
def main():
    mod = ZY5MDenseNet(growth_rate=32, block_config=(6, 16, 12), num_init_features=64, num_classes=1)
    summary(model=mod, input_size=(3, 13, 13), device='cpu')
    print(mod)
