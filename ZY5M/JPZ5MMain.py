...
def conv_bn_act(in_channels: int, out_channels: int, kernel_size, stride=1, padding=0, act=nn.ReLU()):
...
class JPZ5MXL21_Network(nn.Module):
    ...
    def __init__(self, in_channel=3, win_size=16, n_category=1):
        ...
        self.cba1 = conv_bn_act(in_channels=in_channel, out_channels=in_channel * 2, kernel_size=3, padding=1)
        self.cba2 = conv_bn_act(in_channels=in_channel, out_channels=in_channel * 2, kernel_size=3, padding=1)
        self.cba3 = conv_bn_act(in_channels=in_channel, out_channels=in_channel * 2, kernel_size=3, padding=1)
        self.max_pooling1 = nn.MaxPool2d(kernel_size=2, stride=2)
        win_size, in_channel = win_size / 2, in_channel * 2

        self.cba4 = conv_bn_act(in_channels=in_channel, out_channels=in_channel * 2, kernel_size=3, padding=1)
        self.cba5 = conv_bn_act(in_channels=in_channel, out_channels=in_channel, kernel_size=3, padding=1)
        self.max_pooling2 = nn.MaxPool2d(kernel_size=2, stride=2)
        win_size, in_channel = win_size / 2, in_channel * 2

        self.cba6 = conv_bn_act(in_channels=in_channel, out_channels=in_channel * 2, kernel_size=3, padding=1)
        self.cba7 = conv_bn_act(in_channels=in_channel, out_channels=in_channel, kernel_size=3, padding=1)
        self.max_pooling3 = nn.MaxPool2d(kernel_size=2, stride=2)
        win_size, in_channel = win_size / 2, in_channel * 2

        self.cba8 = conv_bn_act(in_channels=in_channel, out_channels=in_channel * 2, kernel_size=3, padding=1)
...
def main():
    ...
    print(            JPZ5M_XIANLI21_DFN.fn(r"GF1C_PMS_E104.0_N13.5_20221019_L1A1021971399\spl1.csv"),
            JPZ5M_XIANLI21_DFN.fn(r"GF1C_PMS_E104.0_N13.5_20221019_L1A1021971399\GF1C_xianli_1.tif"),
            JPZ5M_XIANLI21_DFN.fn(r"GF1C_PMS_E104.0_N13.5_20221019_L1A1021971399\GF1C_xianli_2.tif"), sep="\n")
    pass
